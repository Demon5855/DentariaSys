                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="relative">
                            <form method="GET" action="{{ route('pacientes.index') }}" class="flex items-center">
                                ...
                                @if(request('buscar'))
                                    <a href="{{ route('pacientes.index', ['estado' => $estado]) }}" class="ml-2 px-3 py-2 bg-gray-500 hover:bg-gray-600 text-white rounded-lg text-sm">
                                        Limpiar
                                    </a>
                                @endif
                            </form>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white">
                            ...
                            <tbody>
                                        ...
                                        <td class="py-3 px-4 text-center">
                                            @if($estado === 'activos')
                                                <div class="flex justify-center space-x-2">
                                                    ...
                                                    <form action="{{ route('pacientes.destroy', $paciente) }}" method="POST" onsubmit="return confirm('¿Desactivar paciente?');">
                                                        @csrf
                                                        @method('DELETE')
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="py-8 px-4 text-center text-gray-500">No se encontraron pacientes.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
