            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('pacientes.store') }}" method="POST"
                        x-data="{
                            tipoDocumento: '{{ old('tipo_documento', 'cedula') }}',
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="tipo_documento" name="tipo_documento" x-model="tipoDocumento" required
                                    ...
                                    <option value="temporal" @selected(old('tipo_documento') === 'temporal')>Sin documento (código temporal)</option>
                                </select>
                                <x-input-error :messages="$errors->get('tipo_documento')" class="mt-2" />
                            </div>

                            <div x-show="tipoDocumento !== 'temporal'">
                                ...
                                <x-text-input id="numero_documento" class="block mt-1 w-full" type="text"
                                    ...
                                    x-bind:required="tipoDocumento !== 'temporal'" />
                                <x-input-error :messages="$errors->get('numero_documento')" class="mt-2" />
                            </div>
                            <p x-show="tipoDocumento === 'temporal'" class="text-sm text-gray-500 self-end pb-2">
                                Se generará un código temporal automáticamente.
                            </p>
                            ...
                            <div>
                                ...
                                <x-text-input id="fecha_nacimiento" class="block mt-1 w-full" type="date"
                                    name="fecha_nacimiento" x-model="fechaNacimiento" :value="old('fecha_nacimiento')" required />
                        ...
                        <div x-show="esMenor()" x-cloak class="mt-6 border-t pt-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="representante_nombre" class="block mt-1 w-full" type="text" name="representante_nombre" :value="old('representante_nombre')" />
                                ...
                                <div>
                                    ...
                                    <select id="representante_tipo_documento" name="representante_tipo_documento"
                                        ...
                                        <option value="cedula" @selected(old('representante_tipo_documento', 'cedula') === 'cedula')>Cédula</option>
                                        <option value="pasaporte" @selected(old('representante_tipo_documento') === 'pasaporte')>Pasaporte</option>
                                        <option value="carnet_refugiado" @selected(old('representante_tipo_documento') === 'carnet_refugiado')>Carné de refugiado</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="representante_documento" class="block mt-1 w-full" type="text" name="representante_documento" :value="old('representante_documento')" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="representante_parentesco" class="block mt-1 w-full" type="text" name="representante_parentesco" :value="old('representante_parentesco')" placeholder="Madre, padre, tutor..." />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="representante_telefono" class="block mt-1 w-full" type="text" name="representante_telefono" :value="old('representante_telefono')" />
